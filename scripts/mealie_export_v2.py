...
Usage:
    ...
    python3 scripts/mealie_export_v2.py meal-plans/wochenplan-08-12-dezember.md
    python3 scripts/mealie_export_v2.py neue-rezepte-dezember.md --prefix 2024-12-08
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python3 mealie_export_v2.py <markdown_file> [--prefix YYYY_MM_DD]")
        print("\nBeispiele:")
        print("  python3 mealie_export_v2.py rezepte-2024-12-08-bis-12.md")
        print("  python3 mealie_export_v2.py wochenplan-08-12-dezember.md --prefix 2024_12_08")
        sys.exit(1)
    ...
    print("=" * 60)
    print("📦 Mealie Recipe Exporter v2.0 (Parser-basiert)")
    print("=" * 60)
    print()
